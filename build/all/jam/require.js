...
define('text!templates/templates.handlebars',[],function () { return '<div id="main">\n  <div class="container-fluid">\n    <div id="template-list"><p>Loading...</p></div>\n  </div>\n</div>\n';});

define('text!templates/navigation.handlebars',[],function () { return '<ul class="nav">\n  <li{{#if templates}} class="active"{{/if}}>\n    <a href="#/"><i class="icon-paste"></i> Templates</a>\n  </li>\n  <li{{#if install}} class="active"{{/if}}>\n    <a href="#/install"><i class="icon-download-alt"></i> Install</a>\n  </li>\n  <li{{#if upload}} class="active"{{/if}}>\n    <a href="#/upload"><i class="icon-upload-alt"></i> Upload</a>\n  </li>\n</ul>\n';});

define('text!templates/template-list.handlebars',[],function () { return '<table class="table table-striped table-templates">\n  <thead>\n    <tr>\n      <th>Name</th>\n      <th>ID</th>\n      <th>Description</th>\n      <th>Version</th>\n    </tr>\n  </thead>\n  <tbody>\n    {{#each templates}}\n    <tr>\n      <td class="name">\n        <img class="icon" alt="Icon" src="{{dashicon}}" />\n        {{#if value.dashboard.title}}\n          {{value.dashboard.title}}\n        {{else}}\n          {{id}}\n        {{/if}}\n      </td>\n      <td>{{id}}</td>\n      <td>{{value.dashboard.description}}</td>\n      <td>{{value.dashboard.version}}</td>\n    </tr>\n    {{/each}}\n  </tbody>\n</table>\n';});
...
define('text!templates/install.handlebars',[],function () { return '<div id="main">\n  <div class="container-fluid">\n    <h1>Install</h1>\n    <p>\n      To add this template library to your dashboard, add the following URL\n      to your template sources list:\n    </p>\n    <pre>{{source_url}}</pre>\n  </div>\n</div>\n';});

define('lib/views/install',[
    'require',
    'jquery',
    'couchr',
...
define('text!templates/upload.handlebars',[],function () { return '<div id="main">\n  <div class="container-fluid">\n    <h1>Upload</h1>\n    <p>\n      To add or update a template, push your couchapp to the following URL:\n    </p>\n    <pre>{{upload_url}}</pre>\n  </div>\n</div>\n';});

define('lib/views/upload',[
    'require',
    'jquery',
